...
import 'package:final_app/views/Authentication_Views/change_password.dart';
    ...
    if (formKey.currentState.validate()) {
      ...
      if (querySnapshot.docs.length > 0) {
                ...
                Navigator.pushAndRemoveUntil(
                  ...
                  MaterialPageRoute(
                    builder: (BuildContext context) =>
                        ChangePassword(querySnapshot.docs[0].id),
                  ),
                  (route) => false,
                );
              }
        ...
        Fluttertoast.showToast(
            msg:
                "No account linked with this phone number, try signing up instead",
          ...
          FirebaseFirestore.instance
            ...
            if (snapshots.docs.length > 0) {
              Navigator.pushAndRemoveUntil(
                ...
                MaterialPageRoute(
                  builder: (BuildContext context) =>
                      ChangePassword(snapshots.docs[0].id),
                ),
                (route) => false,
              );
            } else {
              Fluttertoast.showToast(
                  msg:
                      "A user with this phone number does not exist, try signing up instead");
            }
          });
        }
      }).catchError((error) => {
